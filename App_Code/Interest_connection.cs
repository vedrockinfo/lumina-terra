...
/// <summary>
/// Summary description for Interest_connection
/// </summary>
public class Interest_connection
{
	...
	public Interest_connection()
	{
        ...
        //con.ConnectionString = ConfigurationManager.ConnectionStrings["GlobalCon"].ToString();
        con.ConnectionString = System.Configuration.ConfigurationManager.AppSettings["ConnectionInterest"].ToString();
	}
