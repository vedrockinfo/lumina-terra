...
/// <summary>
/// Summary description for cms_Connection
/// </summary>
public class cms_Connection
{
	...
	public cms_Connection()
	{
        ...
        con.ConnectionString = ConfigurationManager.ConnectionStrings["CMSCon"].ToString();
	}
    public void open()
    {
